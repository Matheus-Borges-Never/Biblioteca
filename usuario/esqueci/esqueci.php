            ...
            <div class="container has-text-centered" style="margin-bottom: 10vh;">
                <div class="column is-4 is-offset-4">
                    ...
                    <div class="login-box">
                        <?php
                        echo '
                                <form action="verificaEsqueci.php" method="post">
                                ...
                                <div class="field user-box">
                                    <div class="control">
                                        <input placeholder="  Nova Senha" name="txtSenha" class="input is-large" type="password">
                                    </div>
                                </div>

                                <input type="submit" style="text-decoration: none !important; background-color: red !important; color: #fff;" class="button botao is-block is-large is-fullwidth" value="Cadastrar">
