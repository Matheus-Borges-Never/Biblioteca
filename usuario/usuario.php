...
<nav class="navbar navbar-light bg-light fixed-top">
  ...
  <div class="container-fluid">
    <form action="../search/userSearch.php" method="post" id="pesquisa" class="d-flex" role="search">
...
<p>Seja Bem Vindo <b>' . $userName .'</b></p>
';


$retorno = $databaseInstance1->query("select * from livro");
